...
<header>
    <div class="topbar">
        <div class="account">
            ...
            <?php else: ?>
                <a class="button" href="<?php echo e(route('login')); ?>">Login Google</a>
            <?php endif; ?>
        </div>
    </div>
</header>
<main>
    <div class="wrap app-shell">
        <aside class="sidebar">
            ...
            <nav>
                <a href="<?php echo e(route('inventory.index')); ?>" class="<?php echo e(request()->routeIs('inventory.*') ? 'active' : ''); ?>"><span class="nav-icon">≡</span>Pencatatan</a>
                <a href="<?php echo e(route('reports.index')); ?>" class="<?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>"><span class="nav-icon">□</span>Cetak Laporan</a>
                <a href="<?php echo e(route('notifications.index')); ?>" class="<?php echo e(request()->routeIs('notifications.*') ? 'active' : ''); ?>"><span class="nav-icon">✉</span>Notif & Komunikasi</a>
            </nav>
            <div class="sidebar-actions">
                <a href="<?php echo e(route('home')); ?>"><span class="nav-icon">⚙</span>Settings</a>
                <a href="<?php echo e(route('home')); ?>"><span class="nav-icon">?</span>Help</a>
            </div>
        </aside>
